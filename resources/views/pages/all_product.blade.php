				...
				<div class="col-lg-9">
					...
					<div class="shop_content">
						<div class="shop_bar clearfix">
							<div class="shop_product_count"><span>{{ count($product) }}</span></span> products found</div>
                     ...
                     @foreach($product as $pro)
							...
							<div class="product_item is_new">
								...
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{url('public/images/product/'.$pro->image_one) }}" alt="" style="height: 100px; width: 100px;"></div>
