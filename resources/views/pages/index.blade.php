...
@php
    ...
    $bests=DB::table('products')->where('status',1)->where('best_rated',1)->orderBy('id', 'DESC')->limit(8)->get();
...
@foreach($hot as $row)
                            ...
                            <div class="owl-item deals_item">
                                <div class="deals_image"><img src="{{ url('public/images/product/'.$row->image_one)}}" alt=""></div>
...
@foreach($featured as $feature)
                                ...
                                <div class="featured_slider_item">
                                    ...
                                    <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                        <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{url('public/images/product/'.$feature->image_one)}}" alt="" style="width:120px;height:140px;"></div>
                                        <div class="product_content">
                                            @if($feature->discount_price==NULL)
                                            <div class="product_price discount">${{$feature->selling_price }}</span></div>

                                            @else
                                            <div class="product_price discount">${{$feature->discount_price }}<span>${{$feature->selling_price }}</span></div>

                                            @endif
                                            <div class="product_name"><div><a href="{{ url('product/details/'.$feature->id.'/'.$feature->product_name) }}" target="_blank">{{ $feature->product_name }}</a></div></div>
                                            ...
                                            <div class="product_extras">
                                            <button class="product_cart_button addcart" id="{{ $feature->id }}" data-toggle="modal" data-target="#cartModal" onclick=productview(this.id)>Add to Cart</button>
                                        </div>
...
$mid=DB::table('products')
       ...
       ->where('products.status',1)->where('mid_slider',1)->orderBy('id', 'DESC')->get();
        @endphp
<div class="banner_2">
        ...
        <div class="owl-carousel owl-theme banner_2_slider">
            ...
            <div class="owl-item">
                <div class="banner_2_item">
                    ...
                    @else
                    <del><span>${{ $row->selling_price }}</span></del>&nbsp;<h2>${{ $row->discount_price }}</h2>
                    ...
                    @endif
                            ...
                            <div class="col-lg-8 col-md-6 fill_height">
                                <div class="banner_2_image_container">
                                    <div class="banner_2_image"><img src="{{url('public/images/product/'.$row->image_one)}}" alt="" style="height:300px;width:250px;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
@foreach($product as $pro)
                                ...
                                <div class="featured_slider_item">
                                    <div class="border_active"></div>
                                    <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                        <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{url('public/images/product/'.$pro->image_one)}}" alt="" style="width:120px;height:140px;"></div>
                                        <div class="product_content">
                                            @if($pro->discount_price==NULL)
                                            <div class="product_price discount">${{$pro->selling_price }}</span></div>

                                            @else
                                            <div class="product_price discount">${{$pro->discount_price }}<span><del>${{$pro->selling_price }}</del></span></div>

                                            @endif
                                            <div class="product_name"><div><a href="product.html">{{ $pro->product_name }}</a></div></div>
                                            <div class="product_extras">
                                                <div class="product_color">
                                                    <input type="radio" checked name="product_color" style="background:#b19c83">
                                                    <input type="radio" name="product_color" style="background:#000000">
                                        ...
                                        <ul class="product_marks">
                                            ...
                                            <li class="product_mark product_discount">
                                                @php
$amount=$pro->selling_price - $feature->discount_price;
        ...
        <div class="row">
            ...
            <div class="col-lg-4 advert_col">
                ...
                <div class="advert d-flex flex-row align-items-center justify-content-start">
                    ...
                    <div class="ml-auto"><div class="advert_image"><img src="{{ asset('public/frontend/images/modify_1.png')}}" alt=""></div></div>
                </div>
            </div>
            ...
            <div class="col-lg-4 advert_col">
                ...
                <div class="advert d-flex flex-row align-items-center justify-content-start">
                    ...
                    <div class="ml-auto"><div class="advert_image"><img src="{{ asset('public/frontend/images/modify_2.png')}}" alt=""></div></div>
                </div>
            </div>
            ...
            <div class="col-lg-4 advert_col">
                ...
                <div class="advert d-flex flex-row align-items-center justify-content-start">
                    ...
                    <div class="ml-auto"><div class="advert_image"><img src="{{ asset('public/frontend/images/modify_3.png')}}" alt=""></div></div>
                </div>
            </div>
...
@php
    $buyget=DB::table('products')
            ->join('brands','products.brand_id','brands.id')
            ->select('products.*','brands.brand_name')
            ->where('products.status',1)->where('buyone',1)->orderBy('id', 'DESC')->limit(6)->get();
@endphp
            <!-- Trends Slider -->
            <div class="col-lg-9">
...
@foreach($buyget as $buy)
                        <!-- Trends Slider Item -->
                        <div class="owl-item">
                            <div class="trends_item is_new">
                                <div class="trends_image d-flex flex-column align-items-center justify-content-center"><img src="{{url('public/images/product/'.$buy->image_one)}}" alt="" style="width:120px;height:140px;" alt=""></div>
                                <div class="trends_content">
                                    <div class="trends_category"><a href="#">{{ $buy->brand_name }}</a></div>
                                    <div class="trends_info clearfix">
                                        <div class="trends_name"><a href="product.html">{{ $buy->product_name }}</a></div>
                                        @if($buy->discount_price==NULL)
                                        <div class="product_price discount">${{$buy->selling_price }}</span></div>

                                        @else
                                        <div class="product_price discount">${{$buy->discount_price }}<span><del>${{$buy->selling_price }}</del></span></div>
                                ...
                                <ul class="trends_marks">
                                    @if($buy->discount_price==NULL)
                                    <li class="trends_mark trends_new" style="background-color: blue;">new</li>
                                    @else
                                    <li class="trends_mark trends_new">
                                        @php
                                        $amount=$buy->selling_price - $buy->discount_price;
                                        $discount=$amount/$buy->selling_price*100;
                                                                    @endphp
                                                                    {{ intval($discount) }}%
                                ...
                                <button class="addwishlist" data-id="{{ $buy->id }}">
          ...
          <div class="row">
              <div class="col-md-4">
                  <div class="card">
                      ...
                      <div class="card-body">
                          <h5 class="card-title" id="pname" class="text-center"></h5>
                      </div>
                  </div>
              </div>
              <div class="col-md-4">
    ...
    function productview(id){
        $.ajax({
         ...
         success:function(data){
            var image = 'public/images/product/'+data.product.image_one;
