          ...
          <table id="datatable1" class="table display responsive nowrap">
            ...
            <tbody>
              <tr>
                ...
                <td>{{$coupon->created_at?$coupon->created_at->diffForHumans():'null'}}</td>
         <td>{{$coupon->updated_at?$coupon->updated_at->diffForHumans():'null'}}</td>
                <td><a href="{{ URL::to('edit/coupon/'.$coupon->id) }}" class="btn btn-sm btn-info">Edit</a>|<a href="{{ URL::to('delete/coupon/'.$coupon->id) }}" class="btn btn-sm btn-danger" id="delete">Delete</a></td>
              </tr>
              @endforeach
                          </tbody>
          </table>
      ...
      <div class="modal-content tx-size-sm">
        ...
        <div class="modal-body pd-20">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="coupon" name="coupon">
            </div>
            <div class="form-group">
