            ...
            <div class="card pd-20 pd-sm-40">
                ...
                <div class="modal-body pd-20">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$post->post_title_en}}" name="post_title_en">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Post title(hindi)</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$post->post_title_in}}" name="post_title_in">
                      </div>
                      <div class="form-group">
                  ...
                  <textarea class="form-control" id="summernote"  name="details_en">
                    {{$post->details_en}}
                      ...
                      <div class="form-group">
                        <label class="form-control-label">Post Details(in): <span class="tx-danger">*</span></label>
                  ...
                  <textarea class="form-control" id="summernote1"  name="details_in">
                    {{$post->details_in}}
                                  ...
                                  <img width="50px" height="50px" src="{{url('public/images/post/'.$post->post_image)}}" />
                    ...
                    <select class="form-control" name="postcategory_id">
                        <option>Select Blogcategory</option>
                    @foreach($blogs as $blog)
                    <option value="{{$blog->id}}" <?php if ($blog->id == $post->postcategory_id) {
                        echo "selected"; } ?> > {{ $blog->category_name_en }}</option>
                    @endforeach
                    </select>
                                  </div>
                                  <div class="form-group">
