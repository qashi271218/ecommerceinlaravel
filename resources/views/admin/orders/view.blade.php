 ...
 <div class="card pd-20 pd-sm-40 col-lg-12">
          ...
          <div class="table-wrapper">
            <table class="table display responsive nowrap">
             ...
             <td> <img src="{{ URL('public/images/product/'.$row->image_one) }}" height="50px;" width="50px;"> </td>
                 <td>{{ $row->color }}</td>
                 <td>{{ $row->size }}</td>
                 <td>{{ $row->quantity }}</td>
  ...
  @else
  <strong class="text-success text-center">This product has been successfuly Delievered  </strong>
  @endif
