...
@endguest
							...
							<div class="top_bar_user">
                                @guest
                                <div><a href="{{ route('login') }}" target="_blank"><div class="user_icon"><img src="{{ asset('public/frontend/images/user.svg')}}" alt=""></div>Register/Login</a></div>
                                    @else
                                    <ul class="standard_dropdown top_bar_dropdown">
                                        <li>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logo_container">
							<div class="logo"><a href="{{ url('/') }}"><img src="{{ asset('public/frontend/images/logo.png') }}"></a></div>
						</div>
					</div>
                    @php
    ...
    <div class="modal-dialog" role="document">
     ...
     <form method="post" action="{{ route('order.tracking') }}">
      ...
      <div class="modal-body">
          ...
          <input type="text" name="code" required="" class="form-control" placeholder="Your Order Status Code" autocomplete="off">
      </div>
